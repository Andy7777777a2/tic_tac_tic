...
public class tic_tac_toc {
    static private class game{
                    ...
                    for (int i = 0; i < button_board.length; i++) {
                        try {
                            ...
                            if (exist_in_Array(units, DT)) {
                                button_board[1][i] = new Button(label_of_button(game.this));
                                final int fi = i;
        ...
        private class edit extends show{
                        ...
                        j.addMouseListener(new MouseAdapter() {
                            ...
                            public void mousePressed(MouseEvent e){
                                if(e.getButton() == BUTTON3){
                                    chose.show(edit.this, e.getX(), e.getY());
                                }
                            }
                        });
                    }
            ...
            public edit(game game, int x, int y, int number){
                game.super(x, y, number);
            }
        }
        private class game_show extends show{
            Button edit_button = new Button("edit");
            edit edit = new edit(game.this, directions_of_x, directions_of_y, number);
            Panel panel3 = new Panel(new BorderLayout());
            public game_show(game game, int x, int y, int number){
                game.super(x, y, number);
