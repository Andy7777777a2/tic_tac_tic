    ...
    static private class game{
        ...
        class show extends Frame{
            ...
            private class move_setting extends Frame{
                ...
                java.awt.List chosen_direction = new java.awt.List();
                {
                    send.addActionListener((_) -> {
                        try{
                            //locations[directions_map.get(chosen_direction.)] = digital_to_array_transforming(locations, digital_transforming(locations, chosen_locations, locations, locations));
                        }catch(Exception e){}
                    });
                }
            }
