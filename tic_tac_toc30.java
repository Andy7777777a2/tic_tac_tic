...
public class tic_tac_toc30 {
    static private class game{
        ...
        class show extends Frame{
                    ...
                    for (int i = 0; i < button_board.length; i++) {
                        try {
                            ...
                            if (exist_in_Array(units, DT)) {
                                button_board[i] = new Button(label_of_button(game.this));
                                final int fi = i;
                                button_board[i].addActionListener((_) -> {
                                    locations[directions_of_y] = fi;
                                    reflash();
                                });
                                button_board[i].addMouseListener(new MouseAdapter(){
                                    @Override
                            ...
                            try {
                                ...
                                if(exist_in_Array(units, DT)){
                                    ...
                                    button_board[i][j].addActionListener((_) -> {
                                        action_before_change_the_location(null);
                                        locations[directions_of_x] = fi;
                                        locations[directions_of_y] = fj;
                                        action_after_change_the_location(null);
                                        reflash();
                                    ...
                                    button_board[i][j].addMouseListener(new MouseAdapter(){
                                        ...
                                        @Override
                                        public void mouseExited(java.awt.event.MouseEvent ee){
                                            window.setVisible(false);
                                        }
                                    });
                                }
            ...
            private class change_direction extends Frame{
                ...
                java.awt.Choice change = new java.awt.Choice();
            ...
            private class move_setting extends Frame{
                Button send = new Button("send");
                TextField chosen_locations = new TextField();
                java.awt.Choice choose_direction = new java.awt.Choice();
                {
                    send.addActionListener((_) -> {
                        final int par = Integer.parseInt(chosen_locations.getText());
                        try{
                        ...
                        try {
                            ...
                            chosen_locations.getText().equals("") || 
            ...
            private void show_tip(java.awt.event.MouseEvent e,int DT){
                try{
                    text.setText(java.util.Arrays.toString(digital_to_array_transforming(total_numbers_of_directions, DT)));
                    window.removeAll();
                    window.add(text);
                    window.pack();
            ...
            @SuppressWarnings("unused")
            private void action_before_change_the_location(java.awt.event.ActionEvent e){}
            @SuppressWarnings("unused")
            private void action_after_change_the_location(java.awt.event.ActionEvent e){}
        }
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            game_main.initialize(new String[]{"x","y","z"},new int[]{2,3,3}, null);
            game_main.show.setVisible(true);
            //System.exit(0);
        }catch(Exception _){}
    }
}
