...
public class tic_tac_toc35 {
    static private class game{
        ...
        private class game_main{
            ...
            private void initialize(String[] location, int[] total, unit[] edits, String[] players){
                total_numbers_of_directions = total;
                game.this.players = players;
                while (!asList(game.this.players).parallelStream().filter(i -> i.equals(empty)).findAny().isEmpty()) { 
                    //
                }
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            game_main.initialize(new String[]{"x","y","z"},new int[]{2,3,3}, null, new String[]{"O", "X"});
