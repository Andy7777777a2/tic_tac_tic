...
public class tic_tac_toc7 {
    ...
    private class show extends Frame{
        ...
        int[] locations = new int[digital_of_directions.length];
                ...
                for (int j = 0;j<board[i].length;j++){
                    ...
                    try {
                        if(exist(units, digital_transforming(digital_of_directions,directions,ij,locations))){
                            button_board[i][j] = new Button("").addActionListener((_) -> locations[directions_of_x] = i);
                        }
                    } catch (Exception e) {
