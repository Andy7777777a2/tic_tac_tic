...
public class tic_tac_toc31 {
    static private class game{
        ...
        class show extends Frame{
            ...
            private class move_setting extends Frame{
                ...
                Choice choose_direction = new Choice();
                {
                    send.addActionListener((_) -> {
                        ...
                        //try{
                        try {
                            if(chosen_locations.getText().equals("")){return;}
            ...
            private void show_tip(MouseEvent e,int DT){
                try{
            ...
            @SuppressWarnings("unused")
            protected void action_before_change_the_location(ActionEvent e){}
            @SuppressWarnings("unused")
            protected void action_after_change_the_location(ActionEvent e){}
        }
