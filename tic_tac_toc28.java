    ...
    static private class game{
        ...
        class show extends Frame{
            ...
            private class change_direction extends Frame{
                ...
                java.awt.List change = new java.awt.List();
            ...
            private class move_setting extends Frame{
                ...
                java.awt.List choose_direction = new java.awt.List();
                {
                    send.addActionListener((_) -> {
                        //try{
                        try {
                            ...
                            !exist_in_Array(units, digital_transforming(total_numbers_of_directions, 
                                                                        ...
                                                                        new int[]{Integer.parseInt(chosen_locations.getText())}, 
                                                                        locations)))
                            {return;}
                        } catch (Exception e) {
                            // TODO Auto-generated catch block
                        ...
                        locations[directions_map.get(choose_direction.getSelectedItem())] = Integer.parseInt(chosen_locations.getText());
                        reflash();
                        //}catch(Exception e){}
                    });
                    for (String i : directions_map.keySet()) {
