...
public class tic_tac_toc53 {
    private final static char[] EMPTY_BUIDER = new char[]{'-','.','*','#','@','~','`','+','%','$'};
    private static final class game{
        logger.file_logger log() /*throws Exception*/{
            Path root = Paths.get("logs");
            String game_id = logger.file_id_creater.next_game_id();
            logger.file_logger logger_in_log = new logger.file_logger(root, game_id, true);
    ...
    //    }
        class show extends Frame{
            ...
            protected void reflash(){
                ...
                Object[] x_key = kit.get_key(directions_map,directions_of_x);
                Object[] y_key = kit.get_key(directions_map, directions_of_y);
        ...
        private class edit extends show{
            ...
            protected void action_after_reflash_in_edit(@SuppressWarnings("unused") tic_tac_toc53.game game) {}/*/ TODO Auto-generated method stub/*throw new UnsupportedOperationException("Unimplemented method 'action_after_reflash_in_edit'"); */
            @Override
...
/*public*/ class logger{
    ...
    public static class file_logger{
        ...
        public file_logger(Path root_directory, String game_id, boolean exit_if_fail) /*throws IOException*/{
