    ...
    static private class game{
        ...
        class show extends Frame{
            ...
            private void reflash(){
                ...
                show_directions.setText(format("x:%d,y:%d",directions_of_x,directions_of_y));
                ...
                for (int i = 0;i<board.length;i++) {
                    for (int j = 0;j<board[i].length;j++){
                        ...
                        try {
                            ...
                            new Dialog(this,e.getMessage(),true).add(new Label(e.getMessage())).setVisible(true);
                        }
                    }
                }
            ...
            private class change_direction extends Frame{
                ...
                Label witch_is_being_edited = new Label("x");
                {
                    change_button.addActionListener((_) -> {
                        is_x = !is_x;
                        change_button.setLabel(is_x ? "y" : "x");
