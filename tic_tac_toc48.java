...
public class tic_tac_toc48 {
    ...
    private static final class game{
        ...
        game_logger log() /*throws Exception*/{
            Path root = Paths.get("logs");
            String game_id = game_id_creater.next_game_id();
            game_logger logger_in_log = new game_logger(root, game_id);
    ...
    //    }
        class show extends Frame{
            ...
            protected void reflash(){
                ...
                logger.log("log",(directions_of_x == directions_of_y) ? "true" : "false");
                    ...
                    for (int i = 0;i<button_board.length;i++) {
                        for (int j = 0;j<button_board[i].length;j++){
                            ...
                            try {
                                ...
                                logger.log("log", String.valueOf(DT));
                                //if(exist_in_Array(units, DT) && ){
                                        //try{
        ...
        private int digital_transforming(int[] digitals,int[] choosen_digitals,int[] numbers,int[] locations) throws Exception{
            ...
            for (int i : choosen_digitals) {
                logger.log("log",ii + "," + choosen_digitals.toString());
        ...
        private int[] digital_to_array_transforming(int[] digitals,int locations) throws Exception{
            ...
            for (int i = 0 ; i < digitals.length ; i++) {
                logger.log("log",i + "," + digitals.toString());
                result[i] = (int)(locations%table[i] / ((i == 0) ? 1 : table[i-1]));
            }
            logger.log("log",locations + "," + Arrays.toString(result));
            return result;
        }//印記憶體是刻意的
        @SuppressWarnings("ImplicitArrayToString")
        private int[] digital_to_array_transforming(IntSupplier digitals,int locations) throws Exception{//小心邏輯
            ...
            //System.out.println(locations + "," + Arrays.toString(result.toArray()));
                ...
                //System.out.println(table);
                logger.log("log", String.valueOf(table));
            ...
            logger.log("log",result.toString());
        ...
        private String get_a_unused_string(ArrayList<String> used) throws Exception{
            ...
            try{
                ...
                logger.log("log",String.valueOf(empty_builder));
        ...
        private boolean exist_in_Array(unit[] units, int value){
            ...
            logger.log("log",units[0].toString());
            for (unit i : units) {
        ...
        private class edit extends show{
            ...
            protected void action_after_reflash_in_edit(@SuppressWarnings("unused") tic_tac_toc48.game game) {}/*/ TODO Auto-generated method stub/*throw new UnsupportedOperationException("Unimplemented method 'action_after_reflash_in_edit'"); */
            @Override
        ...
        private class game_show extends show{
            ...
            @Override
            protected void action_after_reflash(game game){
                logger.log("log",first ? "true" : "false");
                if(!first){
                    this.add(panel3, BorderLayout.NORTH);
                }
