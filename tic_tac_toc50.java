...
public class tic_tac_toc {
    ...
    private static final class game{
        logger.game_logger log() /*throws Exception*/{
            ...
            logger.game_logger logger_in_log = new logger.game_logger(root, game_id);
    ...
    //    }
        ...
        private int digital_transforming(int[] digitals,int[] choosen_digitals,int[] numbers,int[] locations) throws Exception{
            ...
            ArrayList<Entry<Integer,ArrayList<Integer>>> suspected_digitals = (ArrayList<Entry<Integer,ArrayList<Integer>>>) digital_checker.entrySet().parallelStream().filter(e -> e.getValue().size() > 1).collect(Collectors.toList());
            for (Entry<Integer,ArrayList<Integer>> entry : suspected_digitals) {
                ...
                ArrayList<Integer> chosen_digitals_ArrayList = new ArrayList<>((ArrayList)Arrays.asList(choosen_digitals));
                for (int i : entry.getValue()) {
                    if(i == ob){continue;}
                    choosen_digitals
                }
            ...
            for (int i : choosen_digitals) {
                logger_in_game.log("log",ii + "," + choosen_digitals/* .toString() */);
...
/*public*/ class logger{
    ...
    public static class game_logger{
        ...
        public game_logger(Path root_directory, String game_id) /*throws IOException*/{
